 ...
 * Generated at: 2024-05-22 05:10:46 UTC
...
public final class resetPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    if (email == null || newPassword == null || confPassword == null || 
        email.isEmpty() || newPassword.isEmpty() || confPassword.isEmpty()) {
        ...
        try {
            ...
            request.setAttribute("status", "driver_not_found");
            log("JDBC Driver not found: " + e.getMessage());
            ...
            if (stmt != null) {
                try {
                    ...
                    log("Error closing statement: " + e.getMessage());
                }
            }
            if (conn != null) {
                try {
